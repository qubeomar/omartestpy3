...
from qube.src.api.omartestpy3controller import omartestpy3Controller
from qube.src.api.omartestpy3controller import omartestpy3ItemController
from qube.src.api.versioncontroller import omartestpy3ItemVersionController
...
api.add_resource(omartestpy3ItemVersionController, '/v1/omartestpy3/version')
api.add_resource(omartestpy3Controller, '/v1/omartestpy3')
api.add_resource(omartestpy3ItemController, '/v1/omartestpy3/<string:entity_id>')
