...
from qube.src.api.swagger_models.omartestpy3 import VersionModel
...
class omartestpy3ItemVersionController(Resource):
    def __init__(self, *args, **kwargs):
        super(omartestpy3ItemVersionController, self).__init__(*args, **kwargs)
        self.config = QubeConfig.get_config()

    @swagger.doc(
        {
            'tags': ['omartestpy3'],
            'description': 'omartestpy3 Version operation',
