...
HELLO_VERSION = "/v1/omartestpy3/version"
...
class Testomartestpy3VersionController(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        print("setup")
    ...
    def test_omartestpy3_default_version(self, *args, **kwargs):
    ...
    def test_omartestpy3_git_version(self, *args, **kwargs):
        QubeConfig.get_config().QUBE_VERSION_FILE = resource_filename(
